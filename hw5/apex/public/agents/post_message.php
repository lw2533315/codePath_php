<?php
  ...
  if(isset($_POST['submit'])) {
	...
	$agent_sender_result = find_agent_by_id($current_user['id']);
	$sender = db_fetch_assoc($agent_sender_result);
	$text=$_POST['plain_text'];//information from dropbox.php
	$encrypted_text = pkey_encrypt($text,$agent['public_key']);
