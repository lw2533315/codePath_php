  ...
  <body>
    ...
    <table>
      ...
      <?php while($message = db_fetch_assoc($message_result)) { ?>
        ...
        <?php
			//find the sender array by 
			$send_result = find_agent_by_id($message['sender_id']);
			$sender = db_fetch_assoc($send_result);
			...
			$validity_text = (verify_signature($message_text,$message['signature'],$sender_public_key))? "valid": "invalid";
          // Oooops.
