...
$previous_password = "previous password is increct";
...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo h(u($user['id'])); ?>" method="post">
	...
	<br/>
		...
		<?php echo "Passwords should be at least 12 characters and include at least one uppercase letter, lowercase letter, number, and symbol."  ?><br/><br/>
